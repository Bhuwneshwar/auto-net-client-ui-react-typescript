...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    if (successResponseData && MyDetails) {
      try {
        ...
        if (objData.type === "sent-withdrawal-request") {
          toast.success("Withdrawal request sent successfully", {
            position: "bottom-center",
          });
        }
        if (objData.type === "sent-recharge-request") {
  ...
  return MyDetails ? (
    <div className="dashboard">
      ...
      <div className="front">
        <div className="balance"> Balance: ₹{MyDetails.Balance.toFixed(2)}</div>
        <div className="date">
      ...
      <div className="diamond-bg">
        ...
        <div className="wtb responsive">
            ...
            <div className="fund">
              ...
              >
                ...
                <p>
                  ...
                  {item.expendHistory.level2.id}, {item.expendHistory.referral}
                  -&gt;Referral,
          ...
          <a href="#add-fund" className="fund-add">
            <p>
              <span>{MyDetails.canBuyDiamond.length}</span> Add New Diamond Fund
            </p>
            <div>
              <AddIcon className="i" />
            </div>
